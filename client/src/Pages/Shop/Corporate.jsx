...
import { fetchCorporateProducts } from '../../Actions';
...
Corporate.propTypes = {
    ...
    fetchCorporateProducts: RPT.func,
    currency: RPT.string,
    currency_value: RPT.float
};

const mapStateToProps = state => ({
    products: state.product.corporateProducts,
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        fetchCorporateProducts: data => {
            dispatch(fetchCorporateProducts(data));
        }
    };
};
